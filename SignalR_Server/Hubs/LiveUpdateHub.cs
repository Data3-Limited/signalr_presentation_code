...
namespace TAPP_SignalR.Hubs
{
   ...
   public class LiveUpdateHub : Hub
   {
      ...
      private void HandleReset()
      {
         ...
         if (_gameState.GetPlayerConnectionId(PlayerTypes.player1) != "" && !string.IsNullOrEmpty(_gameState.GetPlayerConnectionId(PlayerTypes.player1)))
         {
            Groups.RemoveFromGroupAsync(Channels.players, _gameState.GetPlayerConnectionId(PlayerTypes.player1));
         }
         if (_gameState.GetPlayerConnectionId(PlayerTypes.player2) != "" && !string.IsNullOrEmpty(_gameState.GetPlayerConnectionId(PlayerTypes.player2)))
         {
